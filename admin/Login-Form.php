...
<section class="p-5 bg-light">
        <div class="container">
          ...
          <button class="btn btn-outline-warning btn-block font-weight-bold" type="submit">Login</button>
          <button class="btn  text-danger display-2 font-weight-bold mt-3" type="register">
          <a class="nav-link  text-danger"  href="Registerhere.php">Register here</a></button>
                    </form>
                </div>
