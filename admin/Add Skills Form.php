  ...
  <head>
    ...
    <section class="p-5 bg-light">
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-12 text mb-3">
              <h1 class="text-info display-4 text-center font-weight-bold">Add Skills</h1>
            </div>
          </div>
        </div>
          ...
          <button class="btn btn-outline-warning btn-block font-weight-bold" type="submit">Submit Skills</button>
            </form>
          </div>
         </div>
       </section>
