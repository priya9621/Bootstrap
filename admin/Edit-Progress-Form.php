        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-12 text mb-3">
              <h1 class="text-info display-4 text-center font-weight-bold">Edit Progress Bar</h1>
            </div>
          </div>
        </div>
          ...
          <button class="btn btn-outline-warning btn-block font-weight-bold" type="submit">Submit</button>
            </form>
          </div>
         </div>
       </section>
